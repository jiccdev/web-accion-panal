...
const WebDemosAuth = () => {
  ...
  const renderContent = () => {
    return (
      <form>
        ...
        {advancedDemosSelected.map((option) => (
          <div
            key={option}
            className="mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] flex bg-gray-50 p-2 rounded"
          >
            <input
        ...
        {/* Aca el Formulario de Solicitud */}
        <div className="mt-5">
          <div className="mb-4">
            <label
  ...
  return (
    <Section>
      <Fragment>
        {/* Show Basic DEMOS */}
        <BasicDemos {...{ basicDemoSelected, setBasicDemoSelected }} />
