    ...
    return (
        <div className="flex flex-wrap w-[100%] sm:w-[90%] md:w-[80%] lg:w-[80%] xl:w-[95%] rounded-2xl bg-white shadow-2xl p-4 md:p-6 xl:p-10">
            <form
                ...
                <h2 className='text-center font-bold mb-10 text-3xl'>¡HAZ CANJE DE MANERA SENCILLA Y EFICAZ Y TEN MÁS INGRESOS!</h2>
                <div className="mb-4">
                    <label
                ...
                <div className="flex items-center ml-6 mt-6">
                    ...
                    />
                    <label htmlFor="termsy" className="text-sm text-gray-500 text-center">
