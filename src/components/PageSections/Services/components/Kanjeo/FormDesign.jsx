...
const FormDesign = () => {
  const [formData, setFormData] = useState({
    ...
    action: 'Servicios: Contacto (Kanjeo)',
    message: 'Servicios: Contacto (Kanjeo)',
    subject: 'Servicios: Contacto (Kanjeo)',
    lastName: '...',
  ...
  const onFormSubmit = async (ev) => {
    ...
    if (Object.values(formData).includes('') || formData?.terms === false) {
      setErrorMsg({
        allFieldRequierd:
