...
const SplideSlideComponent = ({
  ...
  return (
    <SplideSlide>
      <div
        className={`${
          basicDemoSelected === name ? 'border-2 border-amber-500' : ''
      ...
      >
        ...
        <label
          key={name}
          className={`${
            basicDemoSelected === name ? 'bg-amber-500 text-white' : ''
        ...
        >
          <input
            type="checkbox"
            value={name}
            checked={basicDemoSelected === name}
          ...
          <span
            className={`${
              basicDemoSelected === name ? 'text-white' : 'text-gray-900'
            }`}
          >
            {name}
          </span>
