...
const SplideSlideComponent = ({ demo, selectedDemo, handleCheckboxChange }) => {
  const { href, src, name } = demo;
  return (
    <SplideSlide>
      <div
        className={`${
          selectedDemo === name ? 'border-2 border-amber-500' : ''
      ...
      >
        ...
        <label
          key={name}
          className={`${
            selectedDemo === name ? 'bg-amber-500 text-white' : ''
        ...
        >
          ...
          <span
            className={`${
              selectedDemo === name ? 'text-white' : 'text-gray-900'
            }`}
          >
            {name}
          </span>
