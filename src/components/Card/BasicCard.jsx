...
const BasicCard = ({ backgroundColor, data }) => {
	...
	return (
		<div
			className={`${backgroundColor} md:h-56 xl:h-96 text-center py-6 px-4 my-5 xl:my-14 xl:mx-10 shadow-lg rounded-2xl cursor-pointer hover:shadow-xl trasition duration-300 ease-in-out`}
		>
